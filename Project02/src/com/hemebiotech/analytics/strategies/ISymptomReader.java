 ...
 * Pattern, where a concrete class should be used to represent the interface
 * containing the method that groups several classes implementing the interface
 * and the method with different implementations.
 * <p>
